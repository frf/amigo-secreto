...
/**
 * Base class that represents a row from the 'amigo' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Amigo implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AmigoTableMap';
    ...
    /**
     * Compares this with another <code>Amigo</code> instance.  If
     * <code>obj</code> is an instance of <code>Amigo</code>, delegates to
     * <code>equals(Amigo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Amigo The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AmigoTableMap::COL_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAmigoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAmigoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AmigoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('amigo_id_seq')");
    ...
    {
        $pos = AmigoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        $criteria = ChildAmigoQuery::create();
        $criteria->add(AmigoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Amigo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Amigo Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AmigoTableMap::DEFAULT_STRING_FORMAT);
    }
